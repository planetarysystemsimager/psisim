...
class GPI(Instrument):
    ...
    def get_speckle_noise(self, separations, ao_mag, ao_filter, wvs=None, star_spt=None, telescope=None, ao_mag2=None, contrast_dir=None):
        ...
        contrasts_table = np.loadtxt("./SepvCon.csv", dtype = float, skiprows = 2) # Source 2
...
#             fpm_diam_k2   0.306
    ...
    def get_filter_transmission(self,wvs,filter_name):
        ...
        if filter_name == 'H':
            wavelength_transmission = np.loadtxt("./transmission.dat", dtype = float, skiprows = 3)
    ...
    def get_post_processing_gain(self,AngSep):
        ...
        interp_post_processing = si.interp1d([.25,.4,.8],[15.5,13.3,14.1],bounds_error = False, fill_value = ([15.5],[14.1]))
        post_processing_gain = interp_post_processing(AngSep.value)
