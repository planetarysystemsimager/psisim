...
We currently support high-resolution grids of Phoenix and Sonora models. Download these files into the same **directory** and make sure paths are as follows.

The full [Phoenix](ftp://phoenix.astro.physik.uni-goettingen.de/HiResFITS/) HiRes Library can be downloaded through FTP. Specific [Phoenix](http://phoenix.astro.physik.uni-goettingen.de/?page_id=15) files can be installed if desired.
Download Phoenix items into **directory** + *HIResFITS_lib/phoenix.astro.physik.uni-goettingen.de/HiResFITS/PHOENIX-ACES-AGSS-COND-2011/*. Your directory should read: * **directory**/HIResFITS_lib/phoenix.astro.physik.uni-goettingen.de/HiResFITS/PHOENIX-ACES-AGSS-COND-2011/host_model/host_filename*

[Sonora](https://zenodo.org/record/1309035#.XbtLtpNKhMA) files should be unzipped into **directory**/Sonora. Your directory should read: * **directory**/Sonora/file_name*. 
